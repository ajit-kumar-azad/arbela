Ext.define('Arbela.view.cards.OpenWeatherMapHumidity', {
    requires: [
    ...
    viewTemplate: {
        ...
        items: [{
            ...
            items: [{
                ...
                flex: 1,
                bind: {
                    html: '<div style="padding-left: 10px;padding-top: 20px;"><small>{area}</small><span class="bigtext">{humidity}%</span></div>'
                },
                            ...
                            success: function(response) {
                                ...
                                Ext.data.JsonP.request({
                                    ...
                                    success: function(response) {
                                        ...
                                        var values = [];
                                        for (var i = 0; i < l; i++) {
                                            values.push(list[i].main.humidity);
                                        }
